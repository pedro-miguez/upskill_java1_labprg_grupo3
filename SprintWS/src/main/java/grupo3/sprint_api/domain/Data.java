...
import grupo3.sprint_api.exception.DiaInvalidoException;
import grupo3.sprint_api.exception.MesInvalidoException;
...
public class Data implements Comparable<Data> {
    ...
    public Date getDataSQL() {
        return Date.valueOf(this.dataSQLtoString());
    }
